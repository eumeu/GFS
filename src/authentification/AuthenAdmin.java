...
import menu.*;
public class AuthenAdmin extends JFrame implements ActionListener{
	...
	if(e.getSource()==valider){
		...
		try{
			...
			ResultSet r = state.executeQuery("select login,password from utilisateurs where profil = 'administrateur'");
			while (r.next()) {
