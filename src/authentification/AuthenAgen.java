...
import menu.*;
public class AuthenAgen extends JFrame implements ActionListener{
	...
	private void initialize() {
		...
		this.setTitle("Authentification Comptable");
		setVisible(true);
	...
	if(e.getSource()==valider){
		...
		try{
			...
			ResultSet r = state.executeQuery("select login,password from utilisateurs where profil = 'comptable'");
			while (r.next()) {
